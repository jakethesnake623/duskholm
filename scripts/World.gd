...
func _update_camera_room() -> void:
	...
	var rid : String
	if pos.y >= 4320 and pos.x < 0:
		_set_room(-1280, 0, 4320, 5040)
		rid = "room26"
	elif pos.y >= 4320 and pos.x >= 1280:
		_set_room(1280, 2560, 4320, 5040)
		rid = "room28"
	elif pos.y >= 4320:
		_set_room(0, 1280, 4320, 5040)
		rid = "room27"
	elif pos.y >= 3600 and pos.x < 0:
		...
		_set_room(1280, 2560, 2880, 3600)
		rid = "room22"
	elif pos.y >= 2880:
		_set_room(0, 1280, 2880, 3600)
		rid = "room21"
	elif pos.y >= 2160 and pos.x < 0:
		_set_room(-1280, 0, 2160, 2880)
		rid = "room16"
	elif pos.y >= 2160 and pos.x >= 2560:
		_set_room(2560, 3840, 2160, 2880)
		rid = "room19"
	...
	if _room_label:
		const NAMES := {
			...
			"room26": "26 — The Void Crypt",
			"room27": "27 — The Final Sanctum",
			"room28": "28 — The Shattered Core",
		}
